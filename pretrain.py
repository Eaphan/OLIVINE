...
def main():
    ...
    parser.add_argument(
        "--pretrained_path", type=str, default=None, help="provide a pre-trained model"
    )    
    ...
    if args.pretrained_path:
        ...
        # module.model_points.load_state_dict(model_dict['model_points'], strict=False)
        # module.model_images.load_state_dict(model_dict['model_images'], strict=False)
        module.load_state_dict(model_dict['state_dict'], strict=False)
